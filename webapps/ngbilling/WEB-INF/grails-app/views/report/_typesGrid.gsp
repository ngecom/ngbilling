...
<div id="showLink" style="display: none;">
    <g:remoteLink class="cell" action="reports" id="_id_" before="register(this);" onSuccess="render(data, next); animateToTheTop();">
...
$(document).ready(function () {
    $(jqTableGrid).jqGrid({
        url:'<g:createLink action="findTypes"/>',
        datatype: "json",
        colNames:[
            '<g:message code="report.th.type"/>',
            '<g:message code="report.th.count"/>'
        ],
        colModel:[
