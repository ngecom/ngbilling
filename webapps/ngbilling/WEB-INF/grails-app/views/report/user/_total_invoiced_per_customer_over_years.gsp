...
<div class="form-columns">
    <g:applyLayout name="form/text">
        <content tag="label"><g:message code="start_year"/><span id="mandatory-meta-field">*</span></content>
    ...
    <g:applyLayout name="form/text">
        <content tag="label"><g:message code="end_year"/><span id="mandatory-meta-field">*</span></content>
