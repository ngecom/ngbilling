...
<%@ page import="com.sapienter.jbilling.common.CommonConstants; com.sapienter.jbilling.server.user.contact.db.ContactDTO; com.sapienter.jbilling.common.CommonConstants" %>
<html>
<head>
...
<content tag="column2">
    ...
    <g:else>
        <!-- show empty block -->
        <div class="heading"><strong><em><g:message code="partner.detail.not.selected.title"/></em></strong></div>
        <div class="box"><div class="sub-box"><em><g:message code="partner.detail.not.selected.message"/></em></div></div>
