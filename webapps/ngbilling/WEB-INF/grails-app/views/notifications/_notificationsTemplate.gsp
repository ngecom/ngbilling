...
<g:preferenceEquals preferenceId="${CommonConstants.PREFERENCE_USE_JQGRID}" value="1">
    <g:render template="notificationsGrid" model="['lstByCategory': lstByCategory, categoryId: categoryId]"/>
</g:preferenceEquals>
<g:preferenceIsNullOrEquals preferenceId="${CommonConstants.PREFERENCE_USE_JQGRID}" value="0">
    <g:render template="notifications" model="['lstByCategory': lstByCategory, categoryId: categoryId]"/>
