					...
					<div class="column">
						...
						<div class="row">
							...
							<div class="checkboxArea"><g:hiddenField value="${dto?.id}" name="pref[0].id"/>
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[0].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_SELF_DELIVER_PAPER_INVOICES}" name="pref[0].preferenceType.id"/>
						...
						<div class="row">
							...
							<div class="checkboxArea">
								...
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[1].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_INCLUDE_CUSTOMER_NOTES}" name="pref[1].preferenceType.id"/>
						...
						<div class="row">
							...
							<div class="inp-bg">
								...
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[2].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP}" name="pref[2].preferenceType.id"/>
						...
						<div class="row">
							...
							<div class="inp-bg">
								...
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[3].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP2}" name="pref[3].preferenceType.id"/>
						...
						<div class="row">
							...
							<div class="inp-bg">
								...
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[4].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP3}" name="pref[4].preferenceType.id"/>
						...
						<div class="row">
							...
							<div class="checkboxArea">
								...
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[5].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_USE_INVOICE_REMINDERS}" name="pref[5].preferenceType.id"/>
						...
						<div class="row">
							...
							<div class="inp-bg">
								...
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[6].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_NO_OF_DAYS_INVOICE_GEN_1_REMINDER}" name="pref[6].preferenceType.id"/>
						...
						<div class="row">
							...
							<div class="inp-bg">
								...
								<g:hiddenField value="${ServerConstants.ENTITY_TABLE_ID}" name="pref[7].tableId"/>
								<g:hiddenField value="${ServerConstants.PREFERENCE_TYPE_NO_OF_DAYS_NEXT_REMINDER}" name="pref[7].preferenceType.id"/>
