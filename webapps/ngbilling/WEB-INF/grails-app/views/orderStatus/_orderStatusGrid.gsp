...
$(document).ready(function () {
    $(jqTableGrid).jqGrid({
        url:'<g:createLink action="findOrderStatuses"/>',
        datatype: "json",
        colNames:[
            '<g:message code="orderStatus.flag"/>',
            '<g:message code="orderStatus.description"/>'
        ],
        colModel:[
            { name: 'flag', editable: false, search:false, sortable:false, width: 150},
            { name: 'description', editable: false, search:false, sortable:false, width: 150}
        ],
