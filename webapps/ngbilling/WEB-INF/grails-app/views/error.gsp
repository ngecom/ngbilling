...
<g:if test="${ajaxError}">
    <div class="msg-box error wide">
        ...
        <p>
            <g:message code="flash.exception.message.title.ajax"/>
        </p>
    </div>
</g:if>
<g:else>
    <g:if env="production">
        <div class="msg-box error wide">
            <img src="${resource(dir:'images', file:'icon14.gif')}" alt="${message(code:'error.icon.alt',default:'Error')}"/>
            <strong><g:message code="flash.exception.message.title.production"/></strong>
            <p>
                <g:message code="flash.exception.message.production"/>
            </p>
            <!-- spacer -->
            <div>
                <br/>&nbsp;
                    ...
                    <div class="form-columns">
                        ...
                        <table cellpadding="0" cellspacing="0" class="dataTable">
                            ...
                            <tr>
                                ...
                                <td class="value">${errorMessage ?: message(code: 'generic.error.message')}</td>
                            </tr>
                        </table>
