...
<g:preferenceEquals preferenceId="${CommonConstants.PREFERENCE_USE_JQGRID}" value="1">
    <g:render template="billingGrid" model="[lstBillingProcesses: lstBillingProcesses, dataHashMap:dataHashMap]"/>
</g:preferenceEquals>
<g:preferenceIsNullOrEquals preferenceId="${CommonConstants.PREFERENCE_USE_JQGRID}" value="0">
    <g:render template="billing" model="[lstBillingProcesses: lstBillingProcesses, dataHashMap:dataHashMap]"/>
